...
chords, abstract_grammars = get_musical_data('../data/metheny-jazz.mid')
...
def predict_and_sample(inference_model, x_initializer = x_initializer, a_initializer = a_initializer, 
    ...
    indices = torch.LongTensor(np.argmax(pred, axis = -1))
    results = torch.nn.functional.one_hot(tensor=indices, num_classes=78)
    ### END CODE HERE ###
